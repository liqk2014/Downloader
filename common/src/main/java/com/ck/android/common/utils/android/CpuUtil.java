...
import com.ck.android.common.utils.java.FileUtil;
...
public class CpuUtil {
    ...
    public static String printCpuInfo() {
        String info = FileUtil.readFile(CPU_INFO_PATH);
            LogUtil.getInstance().i("_______  CPU :   \n" + info);
    ...
    public static String getCpuName() {
        if (!StringUtil.isEmpty(CPU_NAME)) {
            return CPU_NAME;
        }
        try {
    ...
    public static String getCMDOutputString(String[] args) {
        try {
            ...
            LogUtil.getInstance().i("CMD: " + sb.toString());
