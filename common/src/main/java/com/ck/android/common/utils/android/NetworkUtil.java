...
public class NetworkUtil {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            LogUtil.getInstance().i("-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            LogUtil.getInstance().i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    LogUtil.getInstance().i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    LogUtil.getInstance().i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    LogUtil.getInstance().i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    LogUtil.getInstance().i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                LogUtil.getInstance().i("\n");
            } else {
                LogUtil.getInstance().i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        ...
        if (net != null) {
            ...
            LogUtil.getInstance().i("NetworkInfo: " + net.toString());
