...
public class TelephoneUtil {
    ...
    public static String getIMSI(Context context) {
        ...
        LogUtil.getInstance().i(" IMSI：" + IMSI);
        return IMSI;
    }
    ...
    public static String getIMEI(Context context) {
        ...
        LogUtil.getInstance().i(" IMEI：" + IMEI);
        return IMEI;
    }
    ...
    public static TeleInfo getMtkTeleInfo(Context context) {
        ...
        LogUtil.getInstance().i("MTK: " + teleInfo);
        return teleInfo;
    }
    ...
    public static TeleInfo getMtkTeleInfo2(Context context) {
        ...
        LogUtil.getInstance().i("MTK2: " + teleInfo);
        return teleInfo;
    }
    ...
    public static TeleInfo getQualcommTeleInfo(Context context) {
        ...
        LogUtil.getInstance().i("Qualcomm: " + teleInfo);
        return teleInfo;
    }
    ...
    public static TeleInfo getSpreadtrumTeleInfo(Context context) {
        ...
        LogUtil.getInstance().i("Spreadtrum: " + teleInfo);
        return teleInfo;
    }
}
